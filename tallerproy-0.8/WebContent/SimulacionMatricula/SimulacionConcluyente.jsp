	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<ol class="breadcrumb bc-3">
				...
				<li><a href="#">Simulacion Concluyente</a></li>
			</ol>
			...
			<div class="row">
				<div class="col-md-12 opcion">
					<a download="Demanda_Cursos_Probables.xls" href=""
					...
					<div class="panel panel-dark" data-collapsed="1">
						...
						<div class="panel-heading">
							<div class="panel-title">
								<strong>SIMULACI&Oacute;N DE MATRICULA PROBABLE</strong>
							</div>
								...
								<table id="table-1" class="table responsive">
									...
									<tbody>
										...
										<tr>
											...
											<td align="center"><%=listaArea.get(i).getCursoList().get(j).getSeccion()%>
											</td>
